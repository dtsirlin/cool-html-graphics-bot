...
(function() {
  ...
  Square = (function() {
    ...
    Square.prototype.draw = function() {
      var circRotate, circRotate1, circRotate2, circRotate3, circSize, endAngle, height, i, size, sizeHyp, startAngle, width, x, y;
      ...
      x = -width / 2;
      y = -height / 2;
      circRotate1 = Math.radToDeg(rotateTo(this.x / canvas.width, this.y / canvas.height));
      circRotate2 = circRotate1 - timeInc(6) % 360;
      circRotate3 = circRotate2 - Math.hyp(this.x, this.y) * Math.sin(timeInc(6000));
      circRotate = Math.degToRad(circRotate3);
      circSize = size / Math.PI;
      startAngle = Math.degToRad(0);
      endAngle = Math.degToRad(180);
      ctx.save();
      ctx.translate(this.x, this.y);
      ctx.rotate(circRotate);
      ctx.fillStyle = 'green';
      ctx.beginPath();
      ctx.arc(0, 0, circSize, startAngle, endAngle, false);
      ctx.closePath();
      ctx.fill();
      ctx.fillStyle = 'red';
      ctx.beginPath();
      ctx.arc(0, 0, circSize / 2, startAngle, endAngle, false);
      ctx.closePath();
      ctx.fill();
      return ctx.restore();
    };
