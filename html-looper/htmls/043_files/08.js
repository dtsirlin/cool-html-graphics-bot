...
(function() {
  ...
  Square = (function() {
    ...
    Square.prototype.draw = function() {
      var h, hue, hypotenuse, i, light, mouseAdj, rise, rotation, run, size, squareRotation, w, x, y;
      ...
      h = Math.round(size * Math.cos(timeInc(2800) + Math.hyp(this.x / 300, this.y / 300)));
      w = Math.round(h);
      x = Math.round(-w / 2);
      y = Math.round(-h / 2);
      ctx.save();
      ...
      ctx.fillStyle = hsla(hue % 360, 100, light, 0.4);
  ...
  animloop = function() {
    ...
    if (Mouse.clicks % 2 === 0) {
      decay(-Mouse.xs / canvas.width * 1, -Mouse.ys / canvas.width * 1, 5, -decay.tilt(100));
    }
    return squares.draw();
  };
