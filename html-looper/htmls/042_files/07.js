...
(function() {
  ...
  Mouse.events.move = function(e) {
    ...
    return Mouse.y = parseInt(e.pageY - canvas.bottom);
  };
  ...
  Square = (function() {
    ...
    Square.prototype.draw = function() {
      var h, hue, hypotenuse, i, light, mouseAdj, rise, rotation, run, size, timeInc, w, x, y;
      ...
      rotation = radToDeg(rotateTo(this.x, this.y));
      mouseAdj = Math.hyp(Mouse.x - this.x / 2, Mouse.y - this.y / 2);
      timeInc = -Date.now() / 8;
      hue = hypotenuse + rotation + mouseAdj + timeInc;
      light = (Math.sin(degToRad(hue) + Date.now() / 1600) + 1) * 50;
      ctx.fillStyle = hsla(hue % 360, 100, light, 0.3);
