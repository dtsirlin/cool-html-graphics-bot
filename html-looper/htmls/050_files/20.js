...
(function() {
  'use strict';
  var Follower, Square, animloop, canvas, ctx, hsla, i, rotateTo, spread, squares, tilt, timeInc, _i;
  ...
  */
  ...
  Follower = (function() {
    ...
    Follower.prototype.draw = function() {
      ...
      hue = (this.index - timeInc(96)) % 360;
      light = 50 + Math.sin(-this.clickRotate / 16 + this.index / 12) * 18;
      size = 1 + this.index * 4;
      ctx.save();
      ...
      ctx.rotate(Math.degToRad(this.index - timeInc(640) % 360));
      ctx.strokeStyle = hsla(hue, 100, light, 1 - this.index / 90);
